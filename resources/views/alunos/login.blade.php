            ...
            <div class="card border-0 shadow-lg rounded-4 bg-dark text-white overflow-hidden">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <form action="{{ route('login.submit') }}" method="POST" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="name" class="form-label text-secondary small text-uppercase fw-semibold">Usuário</label>
                            <div class="input-group">
                                ...
                                <input type="text" 
                                       id="name"
                                       name="name" 
                                       class="form-control bg-dark text-info border-secondary @error('name') is-invalid @enderror" 
                        ...
                        <div class="mb-4">
                            <label for="password" class="form-label text-secondary small text-uppercase fw-semibold">Senha</label>
                            <div class="input-group">
                                <span class="input-group-text bg-secondary border-secondary text-info">
                                ...
                                <input type="password" 
                                       id="password"
                                       name="password" 
                                       class="form-control bg-dark text-info border-secondary @error('password') is-invalid @enderror" 
