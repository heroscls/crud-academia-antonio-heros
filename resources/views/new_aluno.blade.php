                ...
                <div class="p-4 p-md-5">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-secondary small mb-0">Preencha as informações para registrar um novo perfil</p>
                            </div>
                        </div>
                        <a href="{{ route('alunos.index') }}" class="btn btn-close-custom rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 40px; height: 40px;" title="Fechar">
                    ...
                    <form action="{{ route('alunos.salvar') }}" method="post">
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-gradient px-5 py-2 fw-semibold d-flex align-items-center gap-2">
                                <i class="fa-solid fa-check"></i> Salvar Aluno
                            </button>
                        </div>
